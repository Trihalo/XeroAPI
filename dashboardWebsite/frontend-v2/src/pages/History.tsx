...
import { fetchHistory, fetchSummaries, type HistoryEntry, type SummaryEntry } from '@/api'
            ...
            <table className="w-full text-xs border-collapse">
              <thead>
                <tr className="border-b border-border bg-muted/50">
                  {headers.map((h, j) => (
                    <th key={j} className="text-left px-3 py-2 font-semibold text-muted-foreground">
                      {h}
                    </th>
                  ))}
                </tr>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm text-muted-foreground">
                    {summaries.length} recent run{summaries.length !== 1 ? 's' : ''}
                  </span>
                </div>
              </CardHeader>
              <CardContent className="p-0">
