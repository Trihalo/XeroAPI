...
const CLIENTS: ClientConfig[] = [
  ...
  },
  {
    ...
    scripts: [
      {
        name: 'Bills Approver',
        description: 'Approves draft bills in Xero for Cosmopolitan Corp and sends an approval notification email.',
        workflowKey: 'cosmo-bills-approver',
        workflowFile: 'cosmoBillsApprover.yml',
        estimatedTime: 30,
        requiresFileUpload: false,
        icon: FileCheck,
      },
